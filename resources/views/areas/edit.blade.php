                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            {{ csrf_field() }} {{method_field('PUT')}}
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 form-control-label" for="text-input">Posicición</label>
                                                    <div class="col-md-9">
                                                        <input type="number" class="form-control" name="pos" placeholder="Posición" value="{{$var['pos']}}" maxlength="30" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-control" name="idmachine" required>
                                                            ...
                                                            <option value="{{$machine['id']}}"  @if($var['idmachines']===$machine['id']) selected='selected' @endif>{{$machine['name']}} </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
